      ...
      <div className="mx-auto grid max-w-5xl items-center gap-14 px-7 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div>
          ...
          <p className="mb-4.5 text-[1.05rem] leading-[1.85] text-parchment-light/78">
            Faço cartomancia há 1 ano, lendo o baralho cigano com uma
            escuta atenta e sem pressa. Cada sessão é conduzida como uma
            conversa — as cartas abrem o caminho, mas quem decide o que fazer
            com ele é sempre você.
          </p>
          <p className="mb-4.5 text-[1.05rem] leading-[1.85] text-parchment-light/78">
            Atendo tanto quem já conhece a cartomancia quanto quem nunca tirou
            uma carta na vida. Não há necessidade de saber &ldquo;como
